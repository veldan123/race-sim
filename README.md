...
- A **Mystery Box costs 100 coins** and unlocks a random better car: **Falcon RS** (acceleration), **Viper GT** (top speed), **Ghost X1** (handling), or **Apex Prime** (all-round best).
...
- `public/game.js` — canvas renderer + arcade physics (per-model speed/accel/grip stats, speed-sensitive steering, drift, off-track drag), a ~13,000 px Catmull-Rom circuit, lap tracking, remote-car interpolation, AI drivers (look-ahead steering with curvature-based braking), garage/coins economy, HUD + minimap.
